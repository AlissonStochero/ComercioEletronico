...
// only use ' for function code
$opt["onAfterSave"] = "function() { var rowid = $('#list1').jqGrid('getGridParam','selrow'); $('#list1').trigger('reloadGrid', [{current:true}]); $('#list1').setSelection(rowid,true); }";
